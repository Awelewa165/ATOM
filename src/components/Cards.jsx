...
import Single from "../assests/icon 1.jpeg";
import Double from "../assests/icon 2.jpeg";
import Triple from "../assests/icon 3.png";
    ...
    <div className="w-full py-[10rem] px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 ">
          ...
          <button className="text-black bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-o py-3 ">
            {" "}
            Start Trial
          </button>
        </div>
